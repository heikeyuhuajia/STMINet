...
def get_loaders_ddp(args):
    ...
    datasets = {'train': training_set, 'val': val_set}
    # dataloaders = {x: DataLoader(datasets[x], batch_size=args.batch_size,
    #                              shuffle=True, sampler=samplers[x], num_workers=args.num_workers, pin_memory=True)
    dataloaders = {
        'train' : DataLoader(datasets['train'], batch_size=args.batch_size,sampler=samplers['train'], num_workers=args.num_workers, pin_memory=True),
        'val' : DataLoader(datasets['val'], batch_size=args.batch_size, num_workers=args.num_workers)
                   }
